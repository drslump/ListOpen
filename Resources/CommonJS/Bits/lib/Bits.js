...
(function(exports){
    ...
    var hasUint32Array = typeof Uint32Array !== 'undefined',
        hasInt32Array = typeof Int32Array !== 'undefined';
     ...
     *
     * If the platform supports Typed Arrays (specifically Uint32Array or Int32Array) they
     * will be used for fixed sets unless the static property Bits.disableTypedArrays is
     * set to true.
     *
    ...
    Bits.prototype.reset = function(size, fill){
        ...
        } else if (hasInt32Array && !Bits.disableTypedArrays && this.fixed) {
            this.buckets = new Int32Array(new ArrayBuffer(size * 4));
            fill = fill === 0 ? null : fill; // Already filled with zeros
        } else if (this.fixed) {
